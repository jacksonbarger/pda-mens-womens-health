...
export const burmeisterQuiz: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      'Proliferative BBD does not increase breast cancer risk',
      'Proliferative BBD increases breast cancer risk',
      'Proliferative BBD decreases breast cancer risk',
  ...
  },
  {
    ...
    options: [
      ...
      'Normal - menarche can occur up to age 18',
      'Pregnancy'
    ],
  ...
  },
  {
    ...
    options: [
      ...
      'Women who just started their cycle OR are peri/postmenopausal',
  ...
  },
  {
    ...
    options: [
      ...
      'Present during period, persist 6 months, require hospitalization',
      'Present throughout entire month, persist indefinitely'
    ],
  ...
  },
  {
    ...
    options: [
      'Positive finding of ovarian cysts on ultrasound',
      'Elevated androgen levels alone',
      'Diagnosis of exclusion after ruling out other causes of menstrual irregularity and hyperandrogenism',
      'Based solely on clinical symptoms'
    ],
  ...
  },
  {
    ...
    options: [
      'Immediately - 9 months is long enough',
      'After 1 year of regular intercourse (since she is <35)',
      'After 6 months of regular intercourse',
  ...
  },
  {
    ...
    options: [
      ...
      'Only suppress ovulation',
      'Kill sperm, prevent ovulation, induce abortion',
  ...
  },
  {
    ...
    options: [
      ...
      'Mastitis; nipple irritation, tissue trauma, chafing',
      'Galactorrhea; hormonal imbalance',
      'BBD; cyclic hormonal changes'
    ],
  ...
  // === MALE REPRODUCTIVE SYSTEM QUESTIONS ===
  {
    ...
    options: [
      ...
      'BPH; age and presence of testosterone',
      'Acute prostatitis; bacterial infection',
  ...
  },
  {
    ...
    options: [
      'Epididymitis; to prevent chronic pain',
      'Testicular torsion; failure to treat can cause loss of fertility or testicle',
      'Orchitis; to prevent bilateral involvement',
      'Testicular cancer; to prevent metastasis'
    ],
  ...
  },
  {
    ...
    options: [
      'Arterial dilation, muscle contraction, venous constriction',
  ...
  // === URINARY TRACT QUESTIONS ===
  {
    ...
    options: [
      'No - asymptomatic bacteriuria is not treated',
  ...
  },
  {
    ...
    options: [
      ...
      'Inability to empty bladder completely; causes overflow incontinence',
      'Increased bladder pressure; causes urge incontinence'
    ],
